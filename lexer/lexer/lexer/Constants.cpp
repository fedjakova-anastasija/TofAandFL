...
//std::vector<std::string>  Constants::REGULAR_WORDS = { "begin", "end", "dcl", "if", "endif", "for", "endfor", "while", "endwhile", "print", "char", "int", "else", "true", "false", "array", "real", "equals", "return", "string", "write" };
